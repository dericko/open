...
const InfoPage = () => (
  <div className={styles.container}>
    <div className={styles.infoPage}>
      ...
      <ul>
        <li>
          Try to find a place that you can sit with your eyes closed for the
      ...
      <ul>
        <li>
          If you have an <strong>issue closing your eyes</strong>, you can let
          them close half way, letting your unfocused gaze stay on a single
          point in front of you.
        </li>
        <li>
          <strong>Try not to force or control the breath</strong>. Instead, let
          it lead the body and mind.
        </li>
        <li>
          If you find your mind to be{" "}
          <strong>especially tired or restless</strong>, unable to focus on the
          meditation itself, you can take 3 deep breaths — active inhale and
          complete exhale — as the full-body feeling of a deep breath can help
          ground you in your present experience
        </li>
        <li>
          If you come to the end of a meditation and realize you were thinking
          the entire time, that’s fine! Note the places your mind went. Don’t
          worry about whether a particular meditation “counts” or not.
        </li>
        <li>
          If you’re able to (and feel the desire to),{" "}
          <strong>you might sit for a few more minutes in silence</strong>,
          following the breath and sensations in the body. Think of it like the
      ...
      <ul>
        ...
        <li>
          ...
          (Brahmananda Ashram). A place I’ve lived and trained. A wonderful
          space.
        </li>
        <li>
